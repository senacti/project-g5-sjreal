...
VALUES
    ('1122334455', 'Juan', 'Carlos', 'Gomez', 'Perez', 'CC', '1980-05-15', 41, '311-222-3344', 'juan@example.com',50),
    ('2233445566', 'Maria', 'Elena', 'Rodriguez', 'Lopez', 'CC', '1975-10-20', 46, '322-333-4445', 'maria@example.com',30),
    ('3344556677', 'Carlos', 'Antonio', 'Perez', 'Gonzalez', 'CE', '1985-03-25', 36, '300-111-2223', 'carlos@example.com',  20),
    ('4455667788', 'Luisa', 'Fernanda', 'Ramirez', 'Castro', 'CC', '1990-12-10', 31, '310-555-6667', 'luisa@example.com',60),
    ('5566778899', 'Javier', 'Alejandro', 'Torres', 'Hernandez', 'CC', '1978-07-05', 43, '315-777-8889', 'javier@example.com',40),
    ('1122334455', 'José', 'Carlos', 'Chiguasuque', 'Perez', 'CC', '1980-05-15', 41, '311-222-3344', 'jose@example.com',100);
...
INSERT INTO `huesped`
            (`cedula _Huesped`,
             ...
             `correo_Huesped`)
VALUES
    ('1122334466', 'Oliver', 'Henry', 'Gomez', 'Davis', 'CC','1984-03-15', 37, '112-233-4466', 'oliver@example.com'),
    ('2233444577', 'Ava', 'Charlotte', 'Martinez', 'Williams', 'TI','2008-10-04', 15, '223-344-4577', 'ava@example.com'),
    ('3344555688', 'Emma', 'Sophia', 'Clark', 'Smith', 'CC','1999-08-29', 22, '334-455-5688', 'emma@example.com'),
    ('4455666799', 'Liam', 'Jacob', 'Johnson', 'Anderson', 'Pasaporte', '1976-07-23', 45, '445-566-6799', 'liam@example.com'),
    ('5566777900', 'Sophia', 'Ava', 'Harris', 'Garcia', 'TI','2008-12-01', 14, '556-677-7900', 'sophia@example.com'),
    ('6677888011', 'Noah', 'Michael', 'Brown', 'Davis', 'CC','1993-05-07', 28, '667-788-8011', 'noah@example.com'),
    ('7788999122', 'Olivia', 'Elizabeth', 'Smith', 'Johnson', 'Pasaporte', '1978-01-20', 43, '778-899-9122', 'olivia@example.com'),
    ('8899000233', 'Liam', 'Jacob', 'Anderson', 'Martinez', 'TI','2000-09-10', 3, '889-900-0233', 'liam@example.com'),
    ('9900111344', 'Emma', 'Sophia', 'Davis', 'Brown', 'CC','1995-03-04', 26, '990-011-1344', 'emma@example.com'),
    ('0011222455', 'Sophia', 'Ava', 'Garcia', 'Clark', 'CE', '1977-11-19', 44, '001-122-2455', 'sophia@example.com'),
    ('1122334577', 'James', 'Benjamin', 'Brown', 'Anderson', 'Pasaporte',  '1989-06-28', 32, '112-233-4577', 'james@example.com'),
    ('2233445688', 'Olivia', 'Elizabeth', 'Clark', 'Smith', 'CE',  '1974-04-03', 47, '223-344-5688', 'olivia@example.com'),
    ('3344556799', 'Liam', 'Jacob', 'Davis', 'Harris', 'CE',  '1982-02-14', 39, '334-455-6799', 'liam@example.com'),
    ('4455667900', 'Ava', 'Charlotte', 'Smith', 'Johnson', 'Pasaporte',  '1997-08-07', 24, '445-566-7900', 'ava@example.com'),
    ('5566778011', 'Sophia', 'Ava', 'Garcia', 'Martinez', 'CE',  '1983-07-01', 38, '556-677-8011', 'sophia@example.com'),
    ('6677889122', 'Noah', 'Michael', 'Brown', 'Clark', 'CC','1990-10-15', 31, '667-788-9122', 'noah@example.com'),
    ('7788999233', 'Olivia', 'Elizabeth', 'Johnson', 'Anderson', 'CE',  '1986-09-25', 35, '778-899-9233', 'olivia@example.com'),
    ('8899000344', 'Emma', 'Sophia', 'Smith', 'Davis', 'TI','2005-12-08', 17, '889-900-0344', 'emma@example.com'),
    ('9900111455', 'Liam', 'Jacob', 'Anderson', 'Garcia', 'Pasaporte',  '1979-03-21', 42, '990-011-1455', 'liam@example.com'),
    ('0011222566', 'Sophia', 'Ava', 'Harris', 'Brown', 'CC','1994-07-11', 27, '001-122-2566', 'sophia@example.com'),
    ('1122334688', 'Noah', 'Michael', 'Martinez', 'Johnson', 'Pasaporte',  '1984-06-19', 37, '112-233-4688', 'noah@example.com'),
    ('2233445799', 'Ava', 'Charlotte', 'Garcia', 'Brown', 'CE',  '1997-01-02', 24, '223-344-5799', 'ava@example.com'),
    ('3344556800', 'Emma', 'Sophia', 'Smith', 'Clark', 'CC','1993-09-27', 28, '334-455-6800', 'emma@example.com'),
    ('4455667911', 'Liam', 'Jacob', 'Harris', 'Anderson', 'Pasaporte',  '1976-12-14', 45, '445-566-7911', 'liam@example.com'),
    ('5566778022', 'Sophia', 'Ava', 'Davis', 'Gonzalez', 'TI','2007-08-30', 16, '556-677-8022', 'sophia@example.com'),
    ('6677889133', 'Oliver', 'Henry', 'Brown', 'Taylor', 'CC','1989-02-12', 32, '667-788-9133', 'oliver@example.com'),
    ('7788999244', 'Olivia', 'Elizabeth', 'Clark', 'Smith', 'CE',  '1975-04-27', 46, '778-899-9244', 'olivia@example.com'),
    ('8899000355', 'Liam', 'Jacob', 'Smith', 'Davis', 'TI','2007-11-19', 15, '889-900-0355', 'liam@example.com'),
    ('9900111466', 'Emma', 'Sophia', 'Harris', 'Garcia', 'CE',  '1985-07-03', 36, '990-011-1466', 'emma@example.com'),
    ('0011222577', 'Sophia', 'Ava', 'Clark', 'Davis', 'CC','1983-03-18', 38, '001-122-2577', 'sophia@example.com'),
    ('1122334799', 'James', 'Benjamin', 'Smith', 'Anderson', 'Pasaporte',  '1996-06-11', 25, '112-233-4799', 'james@example.com'),
    ('2233445800', 'Olivia', 'Elizabeth', 'Garcia', 'Martinez', 'CC','1987-12-24', 34, '223-344-5800', 'olivia@example.com'),
   ('3344556911', 'Liam', 'Jacob', 'Davis', 'Johnson', 'CE',  '1994-01-08', 27, '334-455-6911', 'liam@example.com'),
   ('4455668022', 'Ava', 'Charlotte', 'Harris', 'Brown', 'TI','2010-09-07', 13, '445-566-8022', 'ava@example.com'),
   ('5566779133', 'Sophia', 'Ava', 'Johnson', 'Clark', 'CE',  '1978-05-29', 43, '556-677-9133', 'sophia@example.com'),
   ('6677889244', 'Noah', 'Michael', 'Clark', 'Smith', 'CC','1991-07-22', 30, '667-788-9244', 'noah@example.com'),
   ('7788999355', 'Olivia', 'Elizabeth', 'Smith', 'Garcia', 'TI','2008-04-16', 15, '778-899-9355', 'olivia@example.com'),
   ('8899000466', 'Emma', 'Sophia', 'Davis', 'Brown', 'CE',  '1982-10-31', 39, '889-900-0466', 'emma@example.com'),
   ('9900111577', 'Sophia', 'Ava', 'Harris', 'Taylor', 'Pasaporte',  '1979-08-12', 42, '990-011-1577', 'sophia@example.com'),
   ('0011222688', 'Oliver', 'Henry', 'Brown', 'Anderson', 'CC','1995-02-03', 26, '001-122-2688', 'oliver@example.com'),
   ('1122334800', 'Ava', 'Charlotte', 'Smith', 'Brown', 'CC','1990-04-22', 31, '112-233-4800', 'ava@example.com'),
   ('2233445911', 'Noah', 'Michael', 'Garcia', 'Martinez', 'CE',  '1986-11-15', 35, '223-344-5911', 'noah@example.com'),
   ('3344557022', 'Emma', 'Sophia', 'Davis', 'Johnson', 'TI','2008-02-08', 15, '334-455-7022', 'emma@example.com'),
   ('4455668133', 'Liam', 'Jacob', 'Brown', 'Clark', 'Pasaporte',  '1988-07-29', 33, '445-566-8133', 'liam@example.com'),
   ('5566779244', 'Olivia', 'Elizabeth', 'Clark', 'Davis', 'CE',  '1979-09-14', 42, '556-677-9244', 'olivia@example.com'),
   ('6677889355', 'Sophia', 'Ava', 'Harris', 'Garcia', 'CC','1992-05-03', 29, '667-788-9355', 'sophia@example.com'),
   ('7788999466', 'Oliver', 'Henry', 'Davis', 'Smith', 'TI','2006-12-28', 14, '778-899-9466', 'oliver@example.com'),
   ('8899000577', 'Liam', 'Jacob', 'Harris', 'Anderson', 'CE',  '1983-03-10', 38, '889-900-0577', 'liam@example.com'),
   ('9900111688', 'Emma', 'Sophia', 'Garcia', 'Johnson', 'Pasaporte',  '1990-09-18', 31, '990-011-1688', 'emma@example.com'),
   ('0011222799', 'Sophia', 'Ava', 'Martinez', 'Brown', 'CC','1993-08-05', 28, '001-122-2799', 'sophia@example.com');
